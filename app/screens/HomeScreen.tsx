...
export default function HomeScreen() {
        ...
        Alert.alert(
            ...
            [
                { text: 'Cancelar', style: 'cancel' },
                {
                    ...
                    style: 'destructive',
                    onPress: () => {
                        // Aquí normalmente cerrarías sesión con tu servicio de autenticación
    ...
    const navigateToRoutines = () => {
        router.push('/screens/RoutinesListScreen' as any);
    };
                ...
                >
                    ...
                    <View style={styles.header}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => router.replace('/screens/index' as any)}
                            activeOpacity={0.8}
                        >
